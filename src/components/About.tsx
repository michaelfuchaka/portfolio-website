"use client"
import { FaHtml5, FaCss3Alt, FaJsSquare, FaReact, FaPython, FaGithub } from "react-icons/fa";
import { SiTypescript, SiTailwindcss, SiFlask, SiSqlalchemy, SiNextdotjs, SiPostgresql, SiDocker } from "react-icons/si";
      ...
      <div className="container mx-auto px-8 max-w-5xl">
        ...
        <div className="mt-20 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-gray-800 p-6 rounded-lg hover:bg-gray-700 transition-colors">
              <div className="text-4xl font-bold text-blue-500 mb-2">13</div>
